...
`settings_filename (optional)`: This is the name of JSON settings file that is generated by calling the calibrate function. The `calibrate` function is called by default in the export function. The default value is "settings.json".

`run_calibrate_settings (optional)`: This is the boolean flag indicating whether `calibrate_settings` will be called prior to calling `gen_witness`. For more information about `calibrate_settings` visit [Commands](./About_EZKL/Commands.md#calibrate-settings). The default value is True.

`run_gen_witness (optional)`: This is a boolean flag indicating whether the `gen_witness`. step will be called prior to export. For more information about `gen_witness visit [Commands](./About_EZKL/Commands.md#gen-witness). The default value is True.
...
The `PyRunArgs` struct is a Python-friendly data structure that provides a set of arguments required to perform certain operations in a Rust environment. The structure is defined using the pyclass macro from the pyo3 library which makes it compatible with Python via PyO3/Maturin. The fields of PyRunArgs are accessible from Python, and can be both read and modified like Python classes. Visit [RunArgs](./About_EZKL/RunArgs.md) for more information.
...
**Description**
For more information refer to [GenSRS](./About_EZKL/Commands.md#gensrs)
...
For more information refer to [Generate Witness](./About_EZKL/Commands.md#generate-witness)
...
For more information visit [Mock](./About_EZKL/Commands.md#mock)
...
For more information visit [Setup](./About_EZKL/Commands.md#setup)
...
For more information visit [Prove](./About_EZKL/Commands.md#prove)
...
For more information visit [Aggregate](./About_EZKL/Commands.md#aggregate)
...
For more information visit [VerifyAggr](./About_EZKL/Commands.md#verifyaggr)
...
More information can be found in [Verifying On Chain](Verifying_On-Chain.md).
