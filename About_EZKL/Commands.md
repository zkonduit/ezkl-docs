...
> **Note:** Downsizing an SRS is time consuming, so if you generate a logrows=20 SRS and the circuit uses logrows=17, the prove command will spend most of its time downsizing your kzg.params from 20 to 17. Once you know the logrows you need, use a file of that size for max speed.
